...
export const getByNationality = (nationality: string): string | undefined => countryInfo.find(ci => ci.nationality === nationality)?.alpha_2_code;

export const countryCode3ToCountryCode2: Record<string, string> = {
  AFG: 'AF',
  ALB: 'AL',
  DZA: 'DZ',
  AND: 'AD',
