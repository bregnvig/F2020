...
export const balanceTrigger = onDocumentCreated('transactions/{transactionId}', async event => {
  const db = getFirestore();
  const transaction: Transaction | undefined = event.data.data() as Transaction;
